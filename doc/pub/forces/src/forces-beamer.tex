...
\begin{frame}[plain,fragile]
\frametitle{Models for nuclear forces and derivation of non-relativistic expressions}
...
\begin{block}{Interpretation of phase shifts }

\begin{figure}[ht]
  \centerline{\includegraphics[width=0.7\linewidth]{figslides/phase.png}}
  \caption{
...
\begin{block}{Low energy scattering length }

\begin{figure}[ht]
  \centerline{\includegraphics[width=1.0\linewidth]{figslides/scattering_length.png}}
  \caption{
...
\begin{block}{Nijmegen multi-energy $pp$ PWA phase shifts }


\begin{figure}[ht]
  \centerline{\includegraphics[width=1.0\linewidth]{figslides/nijmegen_pp_phase_shifts.png}}
  \caption{
...
\begin{block}{An example: chiral twobody interactions }
\[
...
\begin{block}{Proton-neutron $^1S_0$ phase shift }
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.7\linewidth]{figslides/phase-pn-1s0_IDAHO_JUELICH.pdf}}
  \caption{
...
\begin{figure}[ht]
  \centerline{\includegraphics[width=0.8\linewidth]{figslides/pnDSG_at_199MeV.pdf}}
  \caption{
  Proton-neutron $^1S_0$ phase shift.
  }
\end{figure}
